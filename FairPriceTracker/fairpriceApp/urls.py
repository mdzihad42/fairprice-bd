...
urlpatterns = [
    ...
    # Admin approval URLs
    path('admin/approve-agent/<int:user_id>/', views.approve_agent, name='approve_agent'),
    path('admin/approve-warehouse/<int:warehouse_id>/', views.approve_warehouse, name='approve_warehouse'),
]